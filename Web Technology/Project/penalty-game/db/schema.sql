...
VALUES ('goalie_difficulty', 'medium') ON DUPLICATE KEY
...
VALUES (
    ...
    (
        'What is the diameter of a standard goal post?',
        '7.32 meters',
        '7.92 meters',
        '8.32 meters',
        '6.72 meters',
    ...
    (
        'Which player is known as "El Pulgarcito del fútbol"?',
        'Maradona',
        'Messi',
        'Ronaldo',
        'Zidane',
    ...
    (
        'How many minutes in each half of football?',
        '40',
        '45',
        '50',
        '35',
    ...
    (
        'A penalty kick is taken from how many yards?',
        '10',
        '12',
        '15',
        '18',
    ...
    (
        'Which trophy is awarded to the best player at the World Cup?',
        'Golden Boot',
        'Golden Ball',
        'Golden Glove',
        'Silver Ball',
