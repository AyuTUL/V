...
imwrite(enhance1Img,"Output/6enchanced1Image.png");
imwrite(enhance2Img,"Output/6enchanced2Image.png");
imwrite(histogramEqualizedGrayscaleImg,"Output/6equalizedImage.png");

print("Output/6histogramGrayscaleImage.png","-dpng");
print("Output/6histogramEqualizedImage.png","-dpng");